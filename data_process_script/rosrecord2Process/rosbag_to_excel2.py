    ...
    try:
        with rosbag.Bag(bag_path, 'r') as bag:
            for topic, msg, t in bag.read_messages():
                ...
                if topic in ['/human_control_input', '/carla/hero/vehicle_control_cmd', 
                                '/carla/hero/vehicle_control_cmd_machine','/mixControl']:
                    # 控制输入数据
...
def main():
    ...
    input_dir = up_dir+"/"+args.Exp_setting+"-"+args.method_setting
    output_dir = up_dir+"/"+args.Exp_setting+"-"+args.method_setting+"/result-mid"
